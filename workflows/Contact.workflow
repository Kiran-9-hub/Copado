...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Email_alert_to_Contacts</fullName>
        <description>Email alert to Contacts</description>
        <protected>false</protected>
        <recipients>
            <recipient>kirankumarsahoo1999429@agentforce.com</recipient>
            <type>user</type>
        </recipients>
        <recipients>
            <recipient>kirankumarsahoo1999@gmail.com</recipient>
            <type>user</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/Contact_Alert_Template</template>
    </alerts>
    <fieldUpdates>
